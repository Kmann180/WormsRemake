...
{
    //CLASS: WormsGame
    //BRIEF: Class that contains all of our defined classes.
    public partial class WormsGame : Game
    {
        GraphicsDeviceManager _graphics; //MonoGame thing
        SpriteBatch _spriteBatch; //Required for rendering
        ...
        protected override void LoadContent()
        {
            ...
            this._world.InitializeObjectComponents();
        }
        ...
        public bool IntersectsPixels(Rectangle rectangleA, Color[] dataA,
